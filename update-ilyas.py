...
--------------------------------------------------
[•] AUTHOR     : \033[1;32mILYSD\033[1;37m
[•] STATUS     : \033[1;32mSUB TO UNLOCK\033[1;37m
--------------------------------------------------
[•] \033[1;37mVERSION    :\033[1;32m 1.0.4 \033[1;37m"UPDATE DONE ENJOY !"\033[1;37m
--------------------------------------------------"""
print("\33[1;32mYOUR KEY IS APPROVED.")
      ...
      tks = ('Hello%20Sir%20!%20Please%20Approve%20My%20Token%20The%20Token%20Is%20:%20'+id);os.system('am start https://wa.me/+923427941197?text='+tks),approval()
      time.sleep(1)
      approval()
  except:
    sys.exit()
...
def approval():
  ...
  try:
    httpCaht = requests.get('https://github.com/ILYASkhan420/Apr/blob/main/Apr.txt').text
    if id in httpCaht:
      print("\33[1;32mYOUR KEY IS APPROVED.")
      msg = str(os.geteuid())
      time.sleep(0.5)
